...
console.log('In renderPage function');        
...
console.log('Before render function called at line#1782');      
...
console.log('In BindEvent function');        
...
console.log('In renderPages function');        
    ...
    factoryObj.renderPDF = function(url, canvasContainer, options) {
        console.log('In renderPDF function');
